      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link to="/islands/1" className="hover:text-white transition-colors">Santorini</Link></li>
              <li><Link to="/islands/2" className="hover:text-white transition-colors">Mykonos</Link></li>
              <li><Link to="/islands/3" className="hover:text-white transition-colors">Paros</Link></li>
              <li><Link to="/islands/4" className="hover:text-white transition-colors">Naxos</Link></li>
            </ul>
          </div>
